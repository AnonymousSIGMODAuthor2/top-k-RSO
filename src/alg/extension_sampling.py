...
from models import SquareGrid, QuadTree  # Assuming SquareGrid is in models.py
...
def quadtree_sampling(S: List[Place], k: int, W: float, m: int, d: int, optimal_psS, optimal_sS):
    ...
    return R, score, sum_psS, sum_psR, prep_time, selection_time, len(leaves), cell_stats